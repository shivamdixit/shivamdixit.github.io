...
Last week I got a chance to attend my first Null HUMLA workshop. People who are not familiar with Null, it is a community of hackers who are wiling to share knowledge and trying to make the world a more secure place. In this post I'll share my experience with the workshop.
...
* Knowledge about various static and dynamic analysis tools for pen-testing
* Various common exploitable vulnerabilities
* Emulators and VMs
* How to start earning money Gangsta style (bug-bounty)

Overall it was a fun and informative session. I met a lots of security enthusiast, discussed about the latest trends in security and made new friends. After all, the best part of any meet-up is the amazing people in it.
...
Looking forward to see you all in the next event!
